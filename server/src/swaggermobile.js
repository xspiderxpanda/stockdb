...
const optionsV3 = {
  definition: {
    openapi: "3.0.0",
    info: {
      title: "Mongokakaidee API Documentation | Mobile",
      version: "3.0.0",
      description:
        "ระบบจัดการข้อมูลสินค้า (Inventory Management API) สำหรับโปรเจกต์ mongokakaidee สำหรับ Mobile",
...
const specs = swaggerJsdoc(optionsV3);
